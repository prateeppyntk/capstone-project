...
## Data Modeling
ในโปรเจคนี้ได้มีการสร้าง Data Warehouse ทั้งหมด 2 ที่ คือ Data Warehouse ที่สำหรับจัดเก็บข้อมูลดิบ (raw data) และ Data Warehouse ที่สำหรับจัดเก็บข้อมูลที่ถูก Transfrom เรียบร้อยแล้วและทำการสร้างเป็น view เพื่อให้สามารถนำข้อมูลไปใช้ต่อในการทำ visualization ดังนั้น Data Model ที่จะทำการแสดงในส่วนนี้ จึงจะประกอบไปด้วย 2 Data Model
