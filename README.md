...
## Data Modeling
ในโปรเจคได้มีการสร้าง Data Warehouse ทั้งหมด 2 ที่ แบ่งเป็น Data Warehouse ที่จัดเก็บข้อมูลดิบ (raw data) และ Data Warehouse ที่จัดเก็บข้อมูลที่ถูก Transfrom และสร้างเป็น view สำหรับนำข้อมูลที่ได้ไปทำ visualization ต่อ 
